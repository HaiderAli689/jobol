...
extension TextFormFieldStyleHelper on CustomTextFormField {
  static OutlineInputBorder get outlineGray30001 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            5.00,
          ),
  ...
  static OutlineInputBorder get outlinePink300 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            5.00,
          ),
  ...
  static OutlineInputBorder get fillGray10001 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            6.00,
          ),
